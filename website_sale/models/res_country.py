...
class ResCountry(models.Model):
    ...
    def get_website_sale_countries(self, mode='billing',website=None):
        res = self.sudo().search([('website_visible', '=', True), ('website_ids', 'in', website.ids)])
        if mode == 'shipping':
    ...
    def get_website_sale_states(self, mode='billing',website=None):
        res = self.sudo().search([('website_visible', '=', True), ('website_ids', 'in', website.ids)]).state_ids
        if mode == 'shipping':
