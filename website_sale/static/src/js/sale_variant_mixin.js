...
_onChangeCombination: function (ev, $parent, combination) {
    ...
    var $compare_price = $parent.find(".oe_compare_price:first");  // Updated selector for compare price
    var $discount_tag = $parent.find('.o_tag:first');  // Updated selector for discount tag

    $price.text(self._priceToStr(combination.price));
    $default_price.text(self._priceToStr(combination.list_price));
    $discount_tag.text(combination.base_percent + '% off');  // Update discount tag
    $compare_price.text(self._priceToStr(combination.compare_list_price));  // Update compare price
